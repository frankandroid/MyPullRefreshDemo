 ...
 */
public class SmartPullableLayoutTwo extends ViewGroup /*implements NestedScrollingParent*/ {
    ...
    public SmartPullableLayoutTwo(Context context) {
        this(context, null);
    }

    public SmartPullableLayoutTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
